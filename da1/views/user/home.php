...
<head>
    ...
    <style>
    .product-list { display: flex; flex-wrap: wrap; gap: 20px; margin-top: 30px; }
    ...
    .owl-theme .owl-dots .owl-dot span { background:rgb(212, 153, 153) !important; }
    @media (max-width: 991px) {
        .main-banner-row { flex-direction: column; }
        .side-banner-col { flex-direction: row; gap: 10px; }
        .side-banner-img { height: 80px; }
        .main-banner-col { margin-bottom: 12px; }
    }
    body {
    background:rgb(250, 247, 247) !important; /* Màu nền đậm hơn, dễ nhận thấy */
}
</style>
</head>
